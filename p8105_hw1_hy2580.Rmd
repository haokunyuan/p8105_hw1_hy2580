...
p1_tibble = tibble(vec_numeric, vec_logical, vec_char, vec_factor)
```
...
p2_tibble = tibble(x, y, vec_logical2, vec_numeric2, vec_factor2)
```

The size of the dataset: `dim(p2_tibble)`
The mean of x: "mean(x)"
